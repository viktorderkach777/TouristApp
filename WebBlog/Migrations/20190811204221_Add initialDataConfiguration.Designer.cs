...
namespace MyCalculation.Migrations
{
    ...
    partial class AddinitialDataConfiguration
    {
            ...
            modelBuilder.Entity("MyCalculation.DAL.Entities.Tours", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            Id = "1",
                            DaysCount = 6,
                            FromData = new DateTime(2019, 8, 11, 23, 42, 21, 76, DateTimeKind.Local).AddTicks(7293),
                            HotelId = "1",
                            Price = 3300m
                        },
                        new
                        {
                            Id = "2",
                            DaysCount = 8,
                            FromData = new DateTime(2019, 8, 11, 23, 42, 21, 77, DateTimeKind.Local).AddTicks(3748),
                            HotelId = "2",
                            Price = 4400m
                        },
                        new
                        {
                            Id = "3",
                            DaysCount = 10,
                            FromData = new DateTime(2019, 8, 11, 23, 42, 21, 77, DateTimeKind.Local).AddTicks(3754),
                            HotelId = "2",
                            Price = 5500m
                        });
                });
