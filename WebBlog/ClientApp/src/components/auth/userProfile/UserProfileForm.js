            ...
            <form onSubmit={this.onSubmitForm}>
                ...
                <div className={classnames('form-group', { 'has-error': !!errors.dateOfBirth })}>
                    ...
                    <div class="input-group">
                        <span class="input-group-text info"><i class="fas fa-birthday-cake"></i></span>
                        <input type="text"
                            className="form-control"
                            id="dateOfBirth"
                            name="dateOfBirth"
                ...
                <div className={classnames('form-group', { 'has-error': !!errors.email })}>
                    ...
                    <div class="input-group">
                        <span class="input-group-text info"><i class="fas fa-at"></i></span>
                        <input type="text"
                            className="form-control"
                            id="email"
                            name="email"
                ...
                <div className="form-group">
                    <div style= {{textAlign: "center"}}>
                        <button type="submit" className="btn btn-info " disabled={isLoading}>Save</button>
                    </div>
...
export default connect(mapStateToProps, { getUserProfile })(UserProfileForm);